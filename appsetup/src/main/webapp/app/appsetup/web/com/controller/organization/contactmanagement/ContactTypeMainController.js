Ext.define('Appsetup.appsetup.web.com.controller.organization.contactmanagement.ContactTypeMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appsetup.appsetup.shared.com.model.organization.contactmanagement.ContactTypeModel',
               autoLoad: true,
