Ext.define('Appsetup.appsetup.web.com.controller.appbasicsetup.usermanagement.QuestionMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appsetup.appsetup.shared.com.model.appbasicsetup.usermanagement.QuestionModel',
               autoLoad: true,
