Ext.define('Appsetup.appsetup.web.com.controller.organization.contactmanagement.SocialCategoryMainController', {
     extend: 'Appsetup.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.SocialCategoryMainController',
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#SocialCategoryForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#SocialCategoryGrid');
               var tree = this.view.down('#SocialCategoryTree');
               if (method == 'PUT') {
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#SocialCategoryForm');
          var grid = this.view.down('#SocialCategoryGrid');
          var tree = this.view.down('#SocialCategoryTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#SocialCategoryGrid');
               ...
               var formPanel = this.getView().up().down('#SocialCategoryForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var data = this.findRecordById(this.view.restURL, jsonData);
          var treePanel = this.view.up().up().down('#SocialCategoryTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#SocialCategoryForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appsetup.appsetup.shared.com.model.organization.contactmanagement.SocialCategoryModel',
               autoLoad: true,
