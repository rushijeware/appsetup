Ext.define('Appsetup.appsetup.web.com.controller.organization.contactmanagement.PhoneCategoryMainController', {
     extend: 'Appsetup.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.PhoneCategoryMainController',
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#PhoneCategoryForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#PhoneCategoryGrid');
               var tree = this.view.down('#PhoneCategoryTree');
               if (method == 'PUT') {
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#PhoneCategoryForm');
          var grid = this.view.down('#PhoneCategoryGrid');
          var tree = this.view.down('#PhoneCategoryTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#PhoneCategoryGrid');
               ...
               var formPanel = this.getView().up().down('#PhoneCategoryForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var data = this.findRecordById(this.view.restURL, jsonData);
          var treePanel = this.view.up().up().down('#PhoneCategoryTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#PhoneCategoryForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Appsetup.appsetup.shared.com.model.organization.contactmanagement.PhoneCategoryModel',
               autoLoad: true,
