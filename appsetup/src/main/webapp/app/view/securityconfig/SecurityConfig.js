 ...
 * 
 */
Ext.define('Appsetup.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Appsetup.view.securityconfig.SecurityConfigController',
			'Appsetup.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
