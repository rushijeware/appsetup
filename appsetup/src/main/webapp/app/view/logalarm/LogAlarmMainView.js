 ...
 * 
 */
Ext.define('Appsetup.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Appsetup.view.logalarm.LogAlarmMainViewController',
			'Appsetup.view.logalarm.tree.LogAlarmTreePanel',
			'Appsetup.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
