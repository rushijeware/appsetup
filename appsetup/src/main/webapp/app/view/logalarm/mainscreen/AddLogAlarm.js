 ...
 * 
 */
Ext.define('Appsetup.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Appsetup.view.logalarm.mainscreen.AddLogAlarmController',
			'Appsetup.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Appsetup.view.logalarm.mainscreen.AppAlarmPanel',
