 ...
 */
Ext.define('Appsetup.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Appsetup.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Appsetup.view.fw.component.DateTimePicker(o);
    },
