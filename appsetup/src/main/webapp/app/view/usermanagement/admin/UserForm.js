Ext.define('Appsetup.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Appsetup.view.usermanagement.admin.AddUserDetailsViewModel', 'Appsetup.model.AddUserDataModel' ],
