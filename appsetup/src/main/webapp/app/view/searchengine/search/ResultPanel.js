Ext
		.define(
				'Appsetup.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Appsetup.view.searchengine.search.SearchEngineMainPanelController','Appsetup.view.searchengine.search.PanelHeaderField' ,'Appsetup.view.searchengine.search.ReportGridView','Appsetup.view.searchengine.search.ReportChartView','Appsetup.view.searchengine.search.documentView','Appsetup.view.searchengine.search.DouMeanView','Appsetup.view.googlemaps.map.MapPanel'],
