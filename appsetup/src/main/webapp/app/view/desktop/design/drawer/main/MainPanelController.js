Ext.define('Appsetup.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Appsetup.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Appsetup.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Appsetup.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Appsetup.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Appsetup.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Appsetup.view.clouddrive.CloudDrive");
    },
