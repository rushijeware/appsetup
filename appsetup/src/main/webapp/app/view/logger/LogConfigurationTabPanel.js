...
Ext
		.define(
				'Appsetup.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Appsetup.view.logger.tabs.details.DetailsTab',
							'Appsetup.view.logger.tabs.fileconnector.FileConnectorTab',
							'Appsetup.view.logger.tabs.dbconnector.DBConnectorTab',
							'Appsetup.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Appsetup.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Appsetup.view.logger.LogConfigurationTabPanelController',
