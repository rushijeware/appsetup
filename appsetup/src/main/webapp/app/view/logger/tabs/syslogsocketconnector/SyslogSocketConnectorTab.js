 ...
 * 
 */
Ext.define('Appsetup.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Appsetup.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
