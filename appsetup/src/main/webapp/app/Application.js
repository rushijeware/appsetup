 ...
 */
Ext.define('Appsetup.Application', {
	...
	requires : [ "Ext.data.Model","Ext.app.ViewModel","Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Appsetup.view.databrowsercalendar.DBCalendar",
			"Appsetup.view.fw.component.CustomComboBox" ,"Appsetup.view.fw.component.TreeComponent",
			"Appsetup.view.fw.component.FileUploadComponent"],
	...
	stores : [ 'Appsetup.store.QueryCriteriaWidgetsStore' ],
	...
	try{
		...
		if (responseText.alarm) {
			if (responseText.alarm.alarmID == "ABSAA254905401" && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Appsetup.view.login.SessionLogin').center();
