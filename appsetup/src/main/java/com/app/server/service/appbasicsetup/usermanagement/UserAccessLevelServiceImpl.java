...
@SourceCodeAuthorClass(createdBy = "deepali", updatedBy = "deepali", versionNumber = "3", comments = "Service for UserAccessLevel Master table Entity", complexity = Complexity.LOW)
...
public class UserAccessLevelServiceImpl extends UserAccessLevelService {
    ...
    public HttpEntity<ResponseBean> findPageWiseData(@RequestParam("page") Integer page, @RequestParam("start") Integer start, @RequestParam("limit") Integer limit) throws Exception {
        ...
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "UserAccessLevel"));
        responseBean.add("data", userAccessLevelrepo.findPageWiseData("UserAccessLevel.findAll", limit, page));
        responseBean.add("totalSize", userAccessLevelrepo.getTotalPageCount("UserAccessLevel.findAll"));
