...
@SourceCodeAuthorClass(createdBy = "deepali", updatedBy = "deepali", versionNumber = "3", comments = "Service for Timezone Master table Entity", complexity = Complexity.LOW)
...
public class TimezoneServiceImpl extends TimezoneService {
    ...
    /**
     * Retrieve Page-wise list of  <Timezone> object
     * @return HttpEntity<ResponseBean>
     * @throws java.lang.Exception
     */
    ...
    public HttpEntity<ResponseBean> findPageWiseData(@RequestParam("page") Integer page, @RequestParam("start") Integer start, @RequestParam("limit") Integer limit) throws Exception {
        ...
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Timezone"));
        responseBean.add("data", timezonerepo.findPageWiseData("Timezone.findAll", limit, page));
        responseBean.add("totalSize", timezonerepo.getTotalPageCount("Timezone.findAll"));
        Log.out.println(appAlarm.getAlarmID(), runtimeLogInfoHelper.getRequestHeaderBean(), "TimezoneServiceImpl", "findPageWiseData", "Timezone");
        return new ResponseEntity<ResponseBean>(responseBean, HttpStatus.valueOf(appAlarm.getAlarmStatus()));
    }
