...
@SourceCodeAuthorClass(createdBy = "deepali", updatedBy = "deepali", versionNumber = "3", comments = "AddressType", complexity = Complexity.LOW)
...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    private static final long serialVersionUID = 1477391836372L;
