...
@SourceCodeAuthorClass(createdBy = "deepali", updatedBy = "deepali", versionNumber = "2", comments = "SocialCategory", complexity = Complexity.LOW)
...
public class SocialCategory implements Serializable, CommonEntityInterface, Comparator<SocialCategory> {
    ...
    private static final long serialVersionUID = 1477391841299L;
    ...
    public void setSocialCatName(String socialCatName) {
        if (socialCatName != null) {
            this.socialCatName = socialCatName;
        }
    }
